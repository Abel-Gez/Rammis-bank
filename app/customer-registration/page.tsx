          ...
          <div className="flex justify-between items-center h-16">
            <Link href="/" className="flex items-center space-x-2">
              ...
              <div className="flex flex-col">
                <span className="text-xl font-bold text-emerald-800">Rammis Bank</span>
                <span className="text-xs text-emerald-600">Customer Registration</span>
              </div>
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid lg:grid-cols-3 gap-12">
          ...
          <div className="space-y-8">
            <div>
              <h1 className="text-3xl font-bold text-gray-900 mb-4">Open Your Islamic Banking Account</h1>
          ...
          <div className="lg:col-span-2">
            <Card className="shadow-lg border-0">
              <CardHeader>
                ...
                <CardDescription>
                  Fill out the form below to start your Islamic banking journey with us.
                </CardDescription>
              </CardHeader>
              <CardContent>
